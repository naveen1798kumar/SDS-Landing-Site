...
const Aboutcom1 = () => {
  return (
    <div className='w-[100%] h-auto'>
        <div className=' w-[100%]  h-screen flex flex-col justify-center items-center'  style={{backgroundImage: `url(${whitebg})`, backgroundPosition:'center', backgroundSize:'cover'}}>
...
=======
          <h2 className='w-[650px] font-bold  mt-20 bg-gradient-to-r(rgb(43,21,93),rgb(117,65,191)) text-center mb-5 text-5xl md:text-6xl lg:text-7xl' data-aos="zoom-in">About Us</h2>
>>>>>>> ff5fbbb83f2205f17003e0cd2612e2ddb8fb5842
