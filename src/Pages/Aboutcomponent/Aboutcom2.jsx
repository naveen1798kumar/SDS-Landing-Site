...
const Aboutcom2 = () => {
  return (
    ...
    <div className='w-[100%] h-auto  p-10 '>
        <div className='w-[90%] h-auto mx-auto p-5 bg-violet-900 text-white  rounded-2xl' data-aos="fade-up" data-aos-delay="200">

            <h2 className=' text-white text-3xl md:text-4xl font-semibold md:mb-10 lg:text-6xl text-center py-6 'data-aos="fade-up" data-aos-delay="300">Some numbers to Support Us</h2>
            
            <div className=' w-[100%] sm:h-auto  flex flex-col justify-center lg:gap-20 gap-8 sm:flex-col flex-wrap lg:flex-row p-8'>

            <div className='flex flex-col justify-between lg:justify-evenly lg:gap-20 gap-8 md:flex-row 'data-aos="fade-up" data-aos-delay="200">
            <div className='w-[100%]  mb-4'data-aos="fade-up" data-aos-delay="200">
                ...
                <div className='w-[100%]  mb-4'data-aos="fade-up" data-aos-delay="300">
             ...
             <div className='flex flex-col justify-between lg:justify-evenly lg:gap-20 gap-8 md:flex-row'data-aos="fade-up" data-aos-delay="200">
             <div className='w-[100%]  mb-4'data-aos="fade-up" data-aos-delay="400">
                ...
                <div className='w-[100%]  mb-4'data-aos="fade-up" data-aos-delay="500">
