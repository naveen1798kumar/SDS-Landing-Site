...
const Aboutcom4 = () => {
  return (
    ...
    <div className='w-[100%] h-auto py-10'>
      <h2 className=' text-gray-900 text-5xl text-center font-bold mb-10 py-5'data-aos="fade-up" data-aos-delay="200">Why SDS ?</h2>
        <div className='w-[100%] h-auto flex flex-col justify-evenly items-center md:flex-row '>
            <div className='w-[350px] h-[250px] flex flex-col justify-evenly items-center text-center p-5'data-aos="fade-up" data-aos-delay="200">
            ...
            <div className='w-[400px] h-[250px] flex flex-col justify-evenly items-center text-center  px-10 lg:border-r-[2px] lg:border-l-[2px] lg:border-gray-200'data-aos="fade-up" data-aos-delay="300">
            ...
            <div className='w-[350px] h-[250px]  flex flex-col justify-evenly items-center text-center p-5'data-aos="fade-up" data-aos-delay="400"> 
