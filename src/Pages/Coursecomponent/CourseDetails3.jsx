  ...
  return (
    ...
    <div className='md:w-[90%] flex flex-col text-black md:flex-row p-10 lg:py-10 '>
      <div className='md:w-[50%] w-[100%] h-auto order-2 mt-10 md:mt-0 md:order-1'>
        ...
        <p className='w-[100%] md:font-lg  py-2 '>Add this credential to your <span className='text-yellow-500 font-montserrat font-bold'>LinkedIn profile, resume, or CV</span>  Share it on social media and in your performance review..</p>
      </div>
