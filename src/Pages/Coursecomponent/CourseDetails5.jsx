...
const CourseDetails5 = () => {
  return (
    ...
    <div className='lg:w-[100vw] w-auto h-auto grid grid-cols-1 lg:grid-cols-2  '>
            <div className=' lg:w-[50vw]  lg:h-[500px] w-auto h-[350px] flex md:p-10 ' data-aos="fade-up" data-aos-duration="150">
           ...
           <div className=' lg:w-[50vw]  lg:h-[500px] w-auto h-[300px]  md:p-5 flex flex-col  md:justify-center justify-around items-left ' data-aos="fade-up">
